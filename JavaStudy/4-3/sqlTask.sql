...
-- [回答]
 SELECT stock_table.quantity, store_table.store_name, goods_table.goods_name FROM stock_table
...
-- [回答]
 ...
 SET
 quantity = 10,
 update_day = '2021/10/08'
 WHERE 
 store_code = 'EA01' AND goods_code = 'S987';
